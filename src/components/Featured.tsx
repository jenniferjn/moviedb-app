        ...
        <div className="movie-list">
          ...
          <Container className="movie-detail">
            ...
            <ol className="d-flex p-0 movie-order">
              <li className={order === 1 ? "active" : ""}
                  onClick={() => setOrder(1)}>
                01
              </li>
              <li className={order === 2 ? "active" : ""}
                  onClick={() => setOrder(2)}>
                02
              </li>
              <li className={order === 3 ? "active" : ""}
                  onClick={() => setOrder(3)}>
                03
              </li>
              <li className={order === 4 ? "active" : ""}
                  onClick={() => setOrder(4)}>
                04
              </li>
              <li className={order === 5 ? "active" : ""}
                  onClick={() => setOrder(5)}>
                05
              </li>
            </ol>
